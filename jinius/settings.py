"""
Django settings for jinius project.
...
SECRET_KEY = 'n7h+zgsd=a=rws#i8-@ahjea&)8=mv6*luu+_ys*y&*x^4p3-q'
...
WSGI_APPLICATION = 'jinius.wsgi.application'
